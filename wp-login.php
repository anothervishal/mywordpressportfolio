...
<html lang="en-US">
	...
	<title>Log In &lsaquo; anothervishal &#8212; WordPress</title>
...
<link rel="stylesheet" id="login-css" href="./wp-admin/css/login.min.css?ver=6.1.1" media="all">
	...
	<link rel="icon" href="./wp-content/uploads/2022/12/LOGO-Recovered-13-150x150.png" sizes="32x32">
<link rel="icon" href="./wp-content/uploads/2022/12/LOGO-Recovered-13-300x300.png" sizes="192x192">
<link rel="apple-touch-icon" href="./wp-content/uploads/2022/12/LOGO-Recovered-13-300x300.png">
<meta name="msapplication-TileImage" content="./wp-content/uploads/2022/12/LOGO-Recovered-13-300x300.png">
	</head>
	...
	<script type="text/javascript">document.body.className = document.body.className.replace('no-js','js');</script>
		...
		<form name="loginform" id="loginform" action="http://localhost/portfolio/wordpress/wp-login.php" method="post">
			<p>
			...
			<p class="submit">
				<input type="submit" name="wp-submit" id="wp-submit" class="button button-primary button-large" value="Log In">
									<input type="hidden" name="redirect_to" value="http://localhost/portfolio/wordpress/wp-admin/">
...
if ( typeof wpOnload === 'function' ) { wpOnload() }</script>
				<p id="backtoblog">
			<a href="./index.html">&larr; Go to anothervishal</a>		</p>
			</div>
...
<script id="wp-util-js-extra">var _wpUtilSettings = {"ajax":{"url":"\/portfolio\/wordpress\/wp-admin\/admin-ajax.php"}};</script>
<script src="./wp-includes/js/wp-util.min.js?ver=6.1.1" id="wp-util-js"></script>
<script id="user-profile-js-extra">var userProfileL10n = {"user_id":"0","nonce":"d6ec09c284"};</script>
